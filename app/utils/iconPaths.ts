...
export const iconPaths: Record<string, IconDef> = {
  ...
  // — contact —
  phone: { body: '<path d="M5 4h3.5l1.8 4.5-2.2 1.6a11 11 0 0 0 5 5l1.6-2.2L19 20v-.5"/><path d="M5 4a2 2 0 0 0-2 2A16 16 0 0 0 19 22a2 2 0 0 0 2-2v-2.5l-4.5-1.8"/>' },
  ...
  whatsapp: {
    mode: 'fill',
    body: '<path d="M12 2.2A9.8 9.8 0 0 0 3.6 17l-1.4 5 5.1-1.3A9.8 9.8 0 1 0 12 2.2zm0 1.8a8 8 0 0 1 6.8 12.2l-.2.3.8 2.9-3-.8-.3.2A8 8 0 1 1 12 4z"/><path d="M9.3 7.1c-.2-.5-.4-.5-.6-.5h-.5c-.2 0-.5 0-.7.3-.3.3-1 .9-1 2.3s1 2.7 1.2 2.9c.1.2 2 3 4.8 4.2 2.4 1 2.9.8 3.4.8.5-.1 1.6-.7 1.9-1.3.2-.7.2-1.2.1-1.3-.1-.1-.3-.2-.6-.3l-2-1c-.3-.1-.5-.1-.6.1l-.9 1.1c-.1.2-.3.2-.5.1-.3-.1-1.2-.5-2.2-1.4-.8-.7-1.4-1.6-1.5-1.9-.2-.3 0-.4.1-.5l.4-.5c.1-.2.2-.3.3-.5 0-.2 0-.3 0-.5l-.9-2.1z"/>',
  },
  instagram: {
    mode: 'fill',
